...
namespace Homo.Bet.Api
{
    ...
    {
        public static List<ViewRelationOfGroupAndUser> GetRelationByUserId(BargainingChipDBContext dbContext, long userId)
        {
        ...
        public static void AddPermissionGroups(long createdBy, long userId, List<long> groupIds, BargainingChipDBContext dbContext)
        {
        ...
        public static void DeletePermissionGroups(long editedBy, long userId, List<long> ids, BargainingChipDBContext dbContext)
        {
