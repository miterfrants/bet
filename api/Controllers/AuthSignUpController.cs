...
namespace Homo.Bet.Api
{
    ...
    public class AuthSignUpController : ControllerBase
    {
        ...
        public AuthSignUpController(BargainingChipDBContext dbContext, IOptions<AppSettings> appSettings, Microsoft.AspNetCore.Hosting.IWebHostEnvironment env, Homo.Api.CommonLocalizer commonLocalizer)
        {
