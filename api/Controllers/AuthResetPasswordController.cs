...
namespace Homo.Bet.Api
{
    ...
    public class AuthResetPasswordController : ControllerBase
    {
        ...
        public AuthResetPasswordController(BargainingChipDBContext dbContext, IOptions<AppSettings> appSettings, Microsoft.AspNetCore.Hosting.IWebHostEnvironment env, Homo.Api.CommonLocalizer commonLocalizer)
        {
